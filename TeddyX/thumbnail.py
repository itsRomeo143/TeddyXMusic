...
from TeddyMusic import BOT_NAME
from TeddyMusic.config import YOUTUBE_IMG_URL
...
async def play_thumb(videoid):
    ...
    try:
        ...
        font = ImageFont.truetype("TeddyX/Font/font2.ttf", 40)
        font2 = ImageFont.truetype("TeddyX/Font/font2.ttf", 70)
        arial = ImageFont.truetype("TeddyX/Font/font2.ttf", 30)
        name_font = ImageFont.truetype("TeddyX/Font/font.ttf", 30)
...
async def queue_thumb(videoid):
    ...
    try:
        ...
        para = textwrap.wrap(title, width=32)
        j = 0
        draw.text((5, 5), f"Teddy MUSIC", fill="white", font=name_font)
        draw.text(
            (600, 150),
            "IN QUEUE",
            fill="white",
