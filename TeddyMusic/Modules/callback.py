...
from TeddyX.inline import menu_markup, song_download_markup, stream_markup
from TeddyX.queues import QUEUE
from TeddyMusic import BOT_NAME, BOT_USERNAME, F_OWNER
from TeddyMusic import bot as Client
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        text="☁ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ☁",
                        url="https://github.com/itsRomeo143/TeddyMusic",
                    )
                ],
            ]
        ),
